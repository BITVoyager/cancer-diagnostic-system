function [eval,MCC_perf,performance,errors] = nn2bs_batch(train_algo,nfeat)

temp1 = load('.\dataset2\training\C11\C11.mat');
C2_1 = temp1.features;

temp2 = load('.\dataset2\training\C12\C12.mat');
C2_2 = temp2.features;
...
% figure, plotconfusion(tTst,yTst,'High Survival vs Low Survival Dataset 2')
% figure, ploterrhist(errors)
% figure, plotroc(tTst,yTst, 'High Survival vs Low Survival Dataset 2')
