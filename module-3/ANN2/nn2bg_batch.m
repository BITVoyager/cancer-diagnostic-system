function [eval,MCC_perf,performance,errors] = nn2bg_batch(train_algo, nfeat)

temp1 = load('.\dataset2\training\C21\C21.mat');
C2_1 = temp1.features;

temp2 = load('.\dataset2\training\C22\C22.mat');
C2_2 = temp2.features;

temp3 = load('.\dataset2\testing\testing.mat');
temp = temp3.features;
...
Y_temp = xlsread('test_labels.xlsx');
Y_test = [];

for i = 1:size(Y_temp,1)
    Y_test = [Y_test;repmat(Y_temp(i,2),16,1)];
end
...
net.divideParam.valInd = 901:960;
net.divideParam.testInd = 961:1600;
...
% figure, plotconfusion(tTst,yTst,'High Grade vs Low Grade Dataset 2')
% figure, ploterrhist(errors)
% figure, plotroc(tTst,yTst, 'High Grade vs Low Grade Dataset 2')
