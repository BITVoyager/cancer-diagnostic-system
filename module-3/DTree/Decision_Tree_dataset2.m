%% Decision trees classifier for dataset 2
function [ Accuracy, MCC_train_trees, MCC_test_trees, FSCORE, AUC, CVLoss, DefaultTree, goodFeatureIdx ] = Decision_Tree_dataset2( Binary_Data, Nb_features )
    ...
    MCC_test_trees = abs(MCC(Y_test,Y_result));
