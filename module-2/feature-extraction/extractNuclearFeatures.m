function [fs, ft, fte] = extractNuclearFeatures(image)
%extractShapeTopologicalFeatures Extract shape and topological features
...
if cIdx ~= 0
    ...
    fs = [tempMean tempStd tempMin tempMax tempMedian tempIqr cIdx / 800];
end
...
fte = extractHaralickFeatures(bw, 2);
